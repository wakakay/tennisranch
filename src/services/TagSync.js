...
class TagSync {
  ...
  async syncTag() {
    ...
    try {
      ...
      await targetConn.query('DELETE FROM tennisranch_4x.tag');
      ...
      if (tags.length > 0) {
        await targetConn.query(
          'INSERT INTO tennisranch_4x.tag (tag_id, name, status) VALUES ?',
